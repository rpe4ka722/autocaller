...
class Abonent(models.Model):
    ...
    patronymic = models.CharField(verbose_name="Отчетство", max_length=30)
    work_phone_number = models.IntegerField(verbose_name="Рабочий номер телефона", blank=True, null=True)
    mobile_phone_number = models.CharField(verbose_name="Мобильный номер телефона", max_length=12)
